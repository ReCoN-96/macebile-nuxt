    ...
    >
      ...
      <div class="px-2 flex flex-col items-center">
        ...
        <ul class="list-disc list-outside pl-3 ">
          ...
          <li class="mt-[10px]">
            Infiltrations d'eau visible à l'intérieur de la maison
          </li>
          <li class="mt-[10px]">
        ...
        <ul class="list-decimal list-inside ">
          ...
          <li class="mt-[10px]">
            Nous remplaçons les tuiles ou les bardeaux endommagés, et réparons les solins si nécessaire.
          </li>
          <li class="mt-[10px] mb-[20px]">
